...
namespace EventEase2.Controllers
{
    public class VenuesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VenuesId,VenuesName,Location,Capacity,ImageUrl")] Venues venues)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenuesId,VenuesName,Location,Capacity,ImageUrl")] Venues venues)
        {
